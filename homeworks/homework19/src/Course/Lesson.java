...
public class Lesson {
    ...
    public Lesson(LocalDate dateOfThe, Student[] attendingStudents, Course course, LocalTime start, boolean hasHomework, boolean hasExam, Teacher teacher) {
